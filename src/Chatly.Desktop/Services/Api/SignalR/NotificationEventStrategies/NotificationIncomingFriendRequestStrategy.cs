...
public sealed class NotificationIncomingFriendRequestStrategy(ILogger<NotificationStrategy<FriendRequestResponse>> logger) : NotificationStrategy<FriendRequestResponse>(logger)
{
