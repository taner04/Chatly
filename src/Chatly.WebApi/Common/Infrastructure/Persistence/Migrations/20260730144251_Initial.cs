    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ParticipantKey = table.Column<string>(type: "character varying(65)", maxLength: 65, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_ChatMembers_ChatId_UserId", x => new { x.ChatId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Messages_ChatMembers_ChatId_SenderId",
                        columns: x => new { x.ChatId, x.SenderId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DirectChats_ParticipantKey",
                table: "DirectChats",
                column: "ParticipantKey",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Messages_ChatId_SenderId",
                table: "Messages",
